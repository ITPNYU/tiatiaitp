...
var CAMERA_CONTROL_IP = CAMERA_STREAM_IP;
...
var rekognition = new AWS.Rekognition({ apiVersion: '2016-06-27', "accessKeyId": "YOUR_ACCESS_KEY_ID", "secretAccessKey": "YOUR_SECRET_ACCESS_KEY", "region": "us-east-1" });
...
function keyPressed() {
	...
	if (key == 'd') {
		...
		var params = {
			CollectionId: 'tiatiaitp', /* required */
			Image: { /* required */
				Bytes: ab
			},
